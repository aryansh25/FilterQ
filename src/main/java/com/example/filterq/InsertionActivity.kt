...
class InsertionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etSuggestion = findViewById(R.id.etSuggest)
    ...
    private fun saveEmployeeData() {
        ...
        val empSuggestion=etSuggestion.text.toString()
...
//        if(empSuggestion.isEmpty()){
//            etSuggestion.error = "Please enter salary"
//        }

        val empId = dbRef.push().key!!

        val employee = EmployeeModel(empId, empName, empAge, empSalary,empSuggestion)
